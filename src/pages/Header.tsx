      ...
      >
        <div className="flex  flex-col-reverse  md:flex-row items-center justify-center gap-10 md:gap-16">
          ...
          >
            ...
            <motion.p
              className="text-5xl   sm:text-6xl md:text-7xl font-extrabold tracking-tight bg-clip-text  bg-gradient-to-r from-amber-200 via-amber-100 to-amber-300 mb-2" // Adjusted size, gradient, tracking
            ...
            {/* Tagline - Clearer */}
            <motion.h1
              className="text-2xl sm:text-3xl font-medium text-amber-100/90 mt-3" // Adjusted size, color
              variants={textVariants} // Use individual text variants
            >
              {t("tagline")}
            </motion.h1>
            ...
            {/* Mission - Readable */}
            <motion.p
              className="text-base sm:text-lg mt-6 text-gray-200/80 leading-relaxed" // Adjusted size, color, leading
              variants={textVariants} // Use individual text variants
            >
              {t("mission")}
            </motion.p>
            ...
            >
              <motion.button
                className="px-8 py-3 text-lg font-semibold text-white bg-gradient-to-r from-[#D91A5F] to-red-400 rounded-full shadow-lg hover:shadow-yellow-300/40 transition-shadow duration-300 sm:px-7 sm:py-2.5 sm:text-base" // Adjusted colors, padding, hover effect
          ...
          >
            ...
            >
              <img
                ...
                className="relative  z-10 drop-shadow-xl w-full h-full sm:w-[180px] sm:h-[180px] md:w-[220px] md:h-[220px]"
              />
      ...
      <div className="absolute bottom-0 left-0 w-full overflow-hidden z-[5]">
        ...
        >
          ...
          <path
            ...
            fill="currentColor" // Or use solid color
