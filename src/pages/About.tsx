  ...
  return (
    <div className="about-container">
      ...
      <div className="expandable-sections">
        {/* Mission Section */}
        <div className="mission expandable-section">
          <div className="section-header" onClick={() => toggleSection('mission')}>
            <h2>Our Mission</h2>
            <span className={`arrow ${expandedSections.mission ? 'expanded' : ''}`}>▼</span>
          </div>
        ...
        {/* History Section */}
        <div className="history expandable-section">
          <div className="section-header" onClick={() => toggleSection('history')}>
            <h2>Our History</h2>
            <span className={`arrow ${expandedSections.history ? 'expanded' : ''}`}>▼</span>
          </div>
        ...
        {/* Values Section */}
        <div className="values expandable-section">
          <div className="section-header" onClick={() => toggleSection('values')}>
            <h2>Our Values</h2>
            <span className={`arrow ${expandedSections.values ? 'expanded' : ''}`}>▼</span>
          </div>
        ...
        {/* Impact Section */}
        <div className="impact expandable-section">
          <div className="section-header" onClick={() => toggleSection('impact')}>
            <h2>Our Impact</h2>
            <span className={`arrow ${expandedSections.impact ? 'expanded' : ''}`}>▼</span>
          </div>
        ...
        {/* Meetings Section */}
        <div className="meetings expandable-section">
          <div className="section-header" onClick={() => toggleSection('meetings')}>
            <h2>Our Meetings</h2>
            <span className={`arrow ${expandedSections.meetings ? 'expanded' : ''}`}>▼</span>
          </div>
        ...
        {/* Join Section */}
        <div className="join expandable-section">
          <div className="section-header" onClick={() => toggleSection('join')}>
            <h2>How to Join</h2>
            <span className={`arrow ${expandedSections.join ? 'expanded' : ''}`}>▼</span>
          </div>
        ...
        <div className="testimonials expandable-section">
          <div className="section-header" onClick={() => toggleSection('testimonials')}>
            <h2>What Our Members Say</h2>
            <span className={`arrow ${expandedSections.testimonials ? 'expanded' : ''}`}>▼</span>
          </div>
        ...
        {/* Contact Section */}
        <div className="contact expandable-section">
          <div className="section-header" onClick={() => toggleSection('contact')}>
            <h2>Get in Touch</h2>
            <span className={`arrow ${expandedSections.contact ? 'expanded' : ''}`}>▼</span>
          </div>
